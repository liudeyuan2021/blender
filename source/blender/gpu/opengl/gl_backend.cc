...
static void detect_workarounds()
{
  ...
  if (GPU_type_matches(GPU_DEVICE_NVIDIA, GPU_OS_ANY, GPU_DRIVER_ANY) && !(epoxy_gl_version()>=40)) {
    GLContext::texture_gather_support = false;
  }
...
void GLBackend::capabilities_init()
{
  ...
  GCaps.mem_stats_support = epoxy_has_gl_extension("GL_NVX_gpu_memory_info") || epoxy_has_gl_extension("GL_ATI_meminfo");
  GCaps.shader_image_load_store_support = epoxy_has_gl_extension("GL_ARB_shader_image_load_store");
  GCaps.compute_shader_support = epoxy_has_gl_extension("GL_ARB_compute_shader") && epoxy_gl_version()>=43;
  ...
  GCaps.shader_storage_buffer_objects_support = epoxy_has_gl_extension("GL_ARB_shader_storage_buffer_object");
  ...
  GLContext::debug_layer_support = epoxy_gl_version()>=43 || epoxy_has_gl_extension("GL_KHR_debug") || epoxy_has_gl_extension("GL_ARB_debug_output");
  ...
  GLContext::native_barycentric_support = epoxy_has_gl_extension("GL_AMD_shader_explicit_vertex_parameter");
  ...
  GLContext::shader_draw_parameters_support = epoxy_has_gl_extension("GL_ARB_shader_draw_parameters");
  GLContext::stencil_texturing_support = epoxy_gl_version()>=43;
  GLContext::texture_cube_map_array_support = epoxy_has_gl_extension("GL_ARB_texture_cube_map_array");
  GLContext::texture_filter_anisotropic_support = epoxy_has_gl_extension("GL_EXT_texture_filter_anisotropic");
  ...
  GLContext::vertex_attrib_binding_support = epoxy_has_gl_extension("GL_ARB_vertex_attrib_binding");
